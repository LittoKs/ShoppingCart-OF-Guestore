...
$(document).ready(function()
{
	...
	$("body").delegate("#proceed","click",function(event)
	{
		event.preventDefault();
		$.ajax({
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel heading"><span class="h3">Orederd Products</span></div>
					<div class="panel body">
						...
						<div class="row" >
							...
							<div class="col-md-2"></div>
							<div class="col-md-2"></div>
							<div class="col-md-2"><input type="submit" value="PROCEED" class="btn btn-success btn-lg" style="float:right;" id="proceed"></div>
							<div class="col-md-2"></div>
